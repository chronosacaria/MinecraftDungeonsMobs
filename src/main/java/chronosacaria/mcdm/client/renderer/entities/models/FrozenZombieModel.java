package chronosacaria.mcdm.client.renderer.entities.models;

import chronosacaria.mcdm.entities.zombies.FrozenZombieEntity;
import net.minecraft.client.model.*;
import net.minecraft.client.render.entity.model.ZombieEntityModel;

public class FrozenZombieModel <T extends FrozenZombieEntity> extends ZombieEntityModel<T> {
     public FrozenZombieModel(ModelPart modelPart){
         super(modelPart);
     }
